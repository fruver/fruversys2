...
// MaterialUI
import {makeStyles, emphasize, createStyles, useTheme, Theme} from '@material-ui/core/styles';
...
function SingleValue(props: SingleValueProps<OptionType>) {
  return (
    <MUITypography className={props.selectProps.classes.singleValue} {...props.innerProps}>
      {props.children}
    </MUITypography>
  );
}
...
function MultiValue(props: MultiValueProps<OptionType>) {
  return (
    <MUIChip
      ...
      deleteIcon={<MUICancelIcon {...props.removeProps} />}
    />
  );
}
...
function Menu(props: MenuProps<OptionType>) {
  return (
    <MUIPaper square className={props.selectProps.classes.paper} {...props.innerProps}>
      {props.children}
    </MUIPaper>
  );
}
